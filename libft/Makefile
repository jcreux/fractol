...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/11/30 06:48:25 by jcreux            #+#    #+#              #
#    Updated: 2019/06/02 19:49:18 by jcreux           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	  ft_ishexa.c ft_isprint.c ft_itoa.c ft_memalloc.c ft_memccpy.c \
	  ...
	  ft_strfind.c ft_abs.c ft_strswap.c
